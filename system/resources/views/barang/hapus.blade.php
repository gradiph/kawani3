        ...
        <div class="col-lg-10 col-lg-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {{ Form::open(['url' => url('barang/'.$barang->id.'/delete/proses'), 'role' => 'form']) }}
                    <div class="row">
                    	<div class="col-lg-5 form-group">
                            {{ Form::label('supplier_id','Kode Barang') }}
                            @if($errors->has())
                                <span class="label label-danger">{{ $errors->first('id') }}</span>
                            @endif
                            <br />
                            {{ Form::text('supplier_id', '', ['title' => 'Kode Supplier', 'class' => 'form-control-static btn-sm', 'size' => '1', 'readonly' => 'readonly']) }}
                            {{ Form::text('no', substr($barang->id,3,4), ['class' => 'form-control-static btn-sm', 'size' => '1', 'maxlength' => '4', 'id' => 'no', 'readonly' => 'readonly']) }}
                    	...
                    	<div class="col-lg-7 form-group">
                            ...
                            @endif
                            {{ Form::text('nama', $barang->nama, ['autofocus' => 'autofocus', 'placeholder' => 'Nama Barang','class' => 'form-control', 'readonly' => 'readonly']) }}
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-3 form-group">
                            ...
                            @endif
                            {{ Form::number('harga_jual', $barang->harga_jual, ['placeholder' => 'Harga Jual','min' => '0','max' => '99999999999','class' => 'form-control', 'readonly' => 'readonly']) }}
                        </div>
                        <div class="col-lg-3 form-group">
                        	{{ Form::label('hpp','HPP') }}
                            @if($errors->has())
                            ...
                            @endif
                            {{ Form::number('hpp', $barang->hpp, ['placeholder' => 'HPP','min' => '0','max' => '99999999999','class' => 'form-control', 'readonly' => 'readonly']) }}
                        </div>
...
$(document).ready(function(e) {
	...
	$("#no").bind('keyup mouseup',function() {
		setId();
	});
});
</script>
