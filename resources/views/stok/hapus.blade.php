@extends('layouts.app')
@section('title') Hapus Stok Cabang {{ $stok->toko->nama }} | @stop
@section('content')
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Hapus Stok Cabang {{ $stok->toko->nama }}
                </div>
                <div class="panel-body">
                    {{ Form::open(['url' => url('stok/'.$stok->id.'/delete/proses'), 'role' => 'form']) }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 form-group">
                            ...
                            @endif
                            {{ Form::number('qty', $stok->qty, ['readonly' => 'readonly', 'placeholder' => 'Jumlah Stok','class' => 'form-control']) }}
                        </div>
