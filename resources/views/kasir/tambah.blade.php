...
<div class="panel panel-default">
	...
	<div class="panel-body">
		{{ Form::open(['url' => 'kasir/processAdd','name' => 'form_transaksi']) }}
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
				...
				@for($i = 0; $i < count($jumlah); $i++)
                    ...
                    <tr>
                        ...
                        <td>{{ $data_barang->nama }}
                        	...
                        	{{ Form::hidden('diskon[]',$diskon[$i]) }}
                        	{{ Form::hidden('subtotal[]',$subtotal) }}</td>
						<td>{{ $jumlah[$i] }}</td>
                ...
                <tfoot>
                	<tr>
                    	<td align="right" colspan="2"><strong>Total Pieces</strong>
                        	{{ Form::hidden('total_pieces',$total_pieces) }}</td>
